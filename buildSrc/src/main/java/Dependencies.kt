object AndroidDependencies {
    ...
    const val constraintLib = "androidx.constraintlayout:constraintlayout:${Versions.constraintVersion}"
...
object KtResultDependencies {
    const val ktResultLib = "com.michael-bull.kotlin-result:kotlin-result:${Versions.ktResultVersion}"
    const val ktResultCoroutinesLib = "com.michael-bull.kotlin-result:kotlin-result-coroutines:${Versions.ktResultVersion}"
}
